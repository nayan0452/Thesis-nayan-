    ...
    std::array<value_t,WIDTH> &high_xor)
{
    ...
    for(size_t i=start;i<end;++i) {
        ...
        value_t leftlow = value_t(_mm_cvtsi128_si64(leftchild[0]));
        value_t rightlow = value_t(_mm_cvtsi128_si64(rightchild[0]));
        value_t lefthigh =
            value_t(_mm_cvtsi128_si64(_mm_srli_si128(leftchild[0],8)));
        value_t righthigh =
            value_t(_mm_cvtsi128_si64(_mm_srli_si128(rightchild[0],8)));
        ...
        for (size_t j=1; j<WIDTH; j+=2) {
            ++w;
            value_t leftlow = value_t(_mm_cvtsi128_si64(leftchild[w]));
            value_t rightlow = value_t(_mm_cvtsi128_si64(rightchild[w]));
            value_t lefthigh =
                value_t(_mm_cvtsi128_si64(_mm_srli_si128(leftchild[w],8)));
            value_t righthigh =
                value_t(_mm_cvtsi128_si64(_mm_srli_si128(rightchild[w],8)));
